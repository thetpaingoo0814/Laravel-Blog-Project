  ...
  <body class="app sidebar-mini">
    ...
    <aside class="app-sidebar">
      ...
      <ul class="app-menu">
        ...
        <li><a class="app-menu__item" href="{{route('categories.index')}}"><i class="app-menu__icon fa fa-file-code-o"></i><span class="app-menu__label">Catagories</span></a></li>
        <li><a class="app-menu__item" href="{{route('subcategories.index')}}"><i class="app-menu__icon fa fa-file-code-o"></i><span class="app-menu__label">Subcatagories</span></a></li>
